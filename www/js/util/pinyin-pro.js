! function(n, h) {
    ...
    "use strict";
    const h = ["zh", "ch", "sh", "z", "c", "s", "b", "p", "m", "f", "d", "t", "n", "l", "g", "k", "h", "j", "q", "x", "r", "y", "w", ""],
        i = ["j", "q", "x"],
        ...
        s = ["ia", "ian", "iang", "iao", "ie", "iu", "iong", "ua", "uai", "uan", "uang", "ue", "ui", "uo", "üan", "üe", "van", "ve"],
        z = {
            "南宫": "nán gōng",
            "第五": "dì wǔ",
            "万俟": "mò qí",
        ...
        y = {
            ...
            "chǐ": [20268, 20360, 21366, 21498, 21582, 22417, 24677, 27503, 32827, 32916, 32995, 34439, 35053, 35115, 35913, 37497, 40786, 40831],
            "xián xuán": [20269],
            "nú nǔ": [20270],
            "bǎi bó": [20271],
            "gū gù": [20272],
            ...
            "lěng": [20919],
            "pàn": [20920, 21028, 21467, 27804, 27886, 28351, 28813, 29257, 30036, 30460, 32833, 34978, 35195, 35402, 37612, 38011, 38934, 40293],
            ...
            "tān chǎn tuō": [21876],
            bo: [21877, 34068],
            "dìng": [21878, 23450, 26903, 30708, 30855, 30880, 30968, 32866, 33114, 33827, 34634, 35330, 35746, 37664, 38189, 38977, 39139, 39268],
            "lāng": [21879],
            "án ān": [21885],
            "kā": [21888, 25814],
            "yóng yú": [21889],
        ...
        f = new class {
            ...
            search(n, h = !1) {
                ...
                for (let h = 0; h < n.length; h++) {
                    ...
                    if (null === i) i = this.root;
                        ...
                        i = i.children.get(u), i.isEnd && g.push(Object.assign(Object.assign({}, i.pattern), {
                            index: h - i.pattern.length + 1
                        }));
                        let n = i.fail;
                        for (; null !== n && n.isEnd;) g.push(Object.assign(Object.assign({}, n.pattern), {
            ...
            filter(n, h = !1) {
                ...
                for (let h = 0; h < n.length; h++) {
                    ...
                    u >= g ? (i.push(n[h]), g = u + s) : z > i[i.length - 1].priority && (i[i.length - 1] = n[h], g = u + s)
                }
                return i
            }
        };
    ...
    const a = /^[\uD800-\uDBFF]$/,
        ...
        O = n => n.replace(/(ā|á|ǎ|à)/g, "a").replace(/(ō|ó|ǒ|ò)/g, "o").replace(/(ē|é|ě|è)/g, "e").replace(/(ī|í|ǐ|ì)/g, "i").replace(/(ū|ú|ǔ|ù)/g, "u").replace(/(ǖ|ǘ|ǚ|ǜ)/g, "ü").replace(/(ń|ň|ǹ)/g, "n").replace(/ḿ|m̀/g, "m"),
        P = n => {
            const s = n.split(" "),
                z = [],
                o = [];
            for (let n of s)
                for (let s of h)
                    if (n.startsWith(s)) {
                        let h = n.slice(s.length); - 1 !== i.indexOf(s) && -1 !== g.indexOf(h) && (h = u[h]), z.push(s), o.push(h);
                        break
                    }
            return {
                final: o.join(" "),
        ...
        v = n => {
            ...
            let i = "",
                g = "",
                u = "";
            return -1 !== s.indexOf(O(h)) ? (i = h[0], g = h[1], u = h.slice(2)) : (g = h[0] || "", u = h.slice(1) || ""), {
                head: i,
                body: g,
                tail: u
            }
        ...
        T = n => {
            ...
            return n.split(" ").forEach((n => {
                h.test(n) ? z.push("1") : i.test(n) ? z.push("2") : g.test(n) ? z.push("3") : u.test(n) ? z.push("4") : s.test(n) ? z.push("0") : z.push("")
            })), z.join(" ")
        },
        C = n => {
            const h = [];
        ...
        F = n => "string" == typeof n || (console.error("The first param of pinyin is error: " + n + ' is not assignable to type "string".'), !1),
        $ = (n, h) => {
            let i = h.nonZh;
        ...
        A = (n, h) => !(1 !== p(n) || !h.multiple) && ((n, h = "normal") => {
            const i = n.charCodeAt(0),
                g = k[n] || ("surname" === h ? z[n] : "") || l[i] || "";
            return g ? g.split(" ").map((h => ({
                origin: n,
                result: h,
                isZh: !0,
                originPinyin: h
        ...
        B = n => {
            for (let h = n.length - 2; h >= 0; h--) {
                const i = n[h],
                    g = n[h + 1];
                a.test(i.origin) && Z.test(g.origin) && (i.origin += g.origin, i.result += g.result, i.originPinyin = i.result, g.delete = !0, h--)
            }
        ...
        return i = ((n, h, i) => {
            ...
            for (let i = 0; i < n.length;) {
                ...
                if (s && i === s.index) {
                    ...
                    let g = 0;
                    for (let u = 0; u < s.length; u++) a.test(s.zh[u - 1]) && Z.test(s.zh[u]) ? h[i + u] = {
                        origin: s.zh[u],
                        result: "",
                        isZh: !0,
                        originPinyin: ""
            ...
            return h
        })(n, i, h.mode || "normal"), i = B(i), i = $(i, h), A(n, h) && (i = A(n, h)), N(i, h), D(i, h), S(i, h), ((n, h, i) => {
            var g;
            if (h.multiple && 1 === p(i)) {
                let h = "";
                n = n.filter((n => {
            ...
            return "array" === h.type ? n.map((n => n.result)) : "all" === h.type ? n.map((n => {
        ...
        M = (n, h, i) => {
            ...
            for (let u = 0; u < n.length; u++) {
                ...
                if (s.forEach((n => {
                        const i = L(n, h);
                        i > z && (z = i)
                    })), z && (h = h.slice(z), g.push(u)), !h) break
            }
            if (h) return null;
            if (i.continuous) {
                const n = g;
            ...
            for (let g = 1; g < u.length; g++) {
                ...
                for (let s = 1; s <= h.length; s++)
                    if (u[g - 1][s - 1] && (1 === s || u[g - 1][s - 1].length)) {
                        ...
                        if (h.length - s <= 6) {
                            if (z.some((n => "any" === i.lastPrecision ? n.includes(h.slice(s - 1, h.length)) : "start" === i.lastPrecision ? n.startsWith(h.slice(s - 1, h.length)) : "first" === i.lastPrecision ? n[0] === h.slice(s - 1, h.length) : "every" === i.lastPrecision && n === h.slice(s - 1, h.length)))) return [...u[g - 1][s - 1], g - 1]
                        }
                        const o = i.precision;
                        if ("start" === o && z.forEach((n => {
                                let i = s;
                                const z = [...u[g - 1][s - 1], g - 1];
                                for (; i <= h.length && n.startsWith(h.slice(s - 1, i));)(!u[g][i] || z.length > u[g][i].length) && (u[g][i] = z), i++
    ...
    const K = n => n.split("").map((n => {
        ...
        Q = n => n.map((n => n.isZh ? n.result.split(" ").map((h => ({
            origin: n.origin,
            result: h,
            isZh: !0,
            originPinyin: h
        }))) : [n])),
        R = (n, h) => "array" === h.type ? Array.from(new Set(n.map((n => n.result)))) : "all" === h.type ? n.map((n => {
            const h = n.isZh ? n.result : "",
                {
                    initial: i,
                    final: g
    ...
    n.convert = function(n, h) {
        ...
        const i = typeof n;
        return "string" == typeof n && (n = n.split(h.separator || " ")), n = n.map((n => {
            const i = null == h ? void 0 : h.format;
            return "numToSymbol" === i ? function(n) {
                const h = Number(n[n.length - 1]);
                if (h >= 0 && h <= 4) {
                    for (let i in V)
                        if (n.includes(i)) return n.slice(0, n.length - 1).replace(i, V[i][h]);
                    return n
                }
                return n
            }(n) : "symbolToNum" === i ? function(n) {
                return `${O(n)}${T(n)}`
            }(n) : "toneNone" === i ? function(n) {
                return O(n)
            }(n) : n
        })), "string" === i ? n.join(h.separator) : n
    }, n.customPinyin = function(n = {}) {
        k = {}, Object.keys(n).sort(((n, h) => p(h) - p(n))).forEach((h => {
            k[h] = n[h]
        }));
        ...
        !1 !== g.insensitive && (n = n.toLowerCase(), h = h.toLowerCase()), "ignore" === g.space && (h = h.replace(/\s/g, ""));
        return "any" === (null == i ? void 0 : i.precision) ? M(n, h, g) : G(n, h, g)
    }, n.pinyin = W, n.polyphonic = function(n, h = J) {
        if (!F(n)) return [];
        if ("" === n) return [];
