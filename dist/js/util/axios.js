! function(e, t) {
    ...
    var R, T = Object.prototype.toString,
        ...
        j = (R = Object.create(null), function(e) {
            var t = T.call(e);
    ...
    var Z, ee = (Z = "undefined" != typeof Uint8Array && k(Uint8Array), function(e) {
    ...
    var ue, ce, fe, le, he = A("AsyncFunction"),
        pe = (ue = "function" == typeof setImmediate, ce = F(Y.postMessage), ue ? setImmediate : ce ? (fe = "axios@".concat(Math.random()), le = [], Y.addEventListener("message", (function(e) {
            var t = e.source,
                r = e.data;
        ...
        de = "undefined" != typeof queueMicrotask ? queueMicrotask.bind(Y) : "undefined" != typeof process && process.nextTick || pe,
        ve = {
            isArray: L,
            isArrayBuffer: _,
            isBuffer: function(e) {
        ...
        return function e(r, n) {
            if (!ve.isUndefined(r)) {
                ...
                l.push(r), ve.forEach(r, (function(r, i) {
                    !0 === (!(ve.isUndefined(r) || null === r) && o.call(t, r, ve.isString(i) ? i.trim() : i, n, h)) && e(r, n ? n.concat(i) : [i])
                })), l.pop()
            }
        }(e), t
    }
    ...
    var Ae, Pe = function() {
        ...
        Ce = (Ae = "undefined" != typeof navigator && navigator.product, _e && ["ReactNative", "NativeScript", "NS"].indexOf(Ae) < 0),
    ...
    Ge.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent", "Authorization"]), ve.reduceDescriptors(Ge.prototype, (function(e, t) {
        var r = e.value,
    ...
    var ut, ct, ft = function(e) {
            var t, r, n = st({}, e),
                ...
                u = n.headers,
                c = n.auth;
            if (n.headers = u = Ke.from(u), n.url = je(it(n.baseURL, n.url), e.params, e.paramsSerializer), c && u.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : ""))), ve.isFormData(o))
        ...
        bt = yt && ("function" == typeof TextEncoder ? (ut = new TextEncoder, function(e) {
            return ut.encode(e)
        }) : function() {
    ...
    yt && (ct = new Response, ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((function(e) {
    ...
    var St = function() {
        ...
        Rt = yt && function() {
            var e = h(u().mark((function e(t) {
                var r, n, o, i, a, c, f, l, h, p, d, v, y, b, g, w, E, O, S, x, R, T, k, j, A, P, L, N, _, C, F, U, B, D, I, q, M;
                return u().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (r = ft(t), n = r.url, o = r.method, i = r.data, a = r.signal, c = r.cancelToken, f = r.timeout, l = r.onDownloadProgress, h = r.onUploadProgress, p = r.responseType, d = r.headers, v = r.withCredentials, y = void 0 === v ? "same-origin" : v, b = r.fetchOptions, p = p ? (p + "").toLowerCase() : "text", g = a || c || f ? ht([a, c], f) : [], w = m(g, 2), E = w[0], O = w[1], R = function() {
                        ...
                        case 11:
                            ...
                            k = new Request(n, {
                                ...
                                body: i,
                                duplex: "half"
                            }), ve.isFormData(i) && (j = k.headers.get("content-type")) && d.setContentType(j), k.body && (A = tt(T, et(rt(h))), P = m(A, 2), L = P[0], N = P[1], i = vt(k.body, 65536, L, N, bt));
                        case 15:
                            return ve.isString(y) || (y = y ? "include" : "omit"), x = new Request(n, s(s({}, b), {}, {
                                signal: E,
                        ...
                        case 19:
                            return _ = e.sent, C = Et && ("stream" === p || "response" === p), Et && (l || C) && (F = {}, ["status", "statusText", "headers"].forEach((function(e) {
                                F[e] = _[e]
                            })), U = ve.toFiniteNumber(_.headers.get("content-length")), B = l && tt(U, et(rt(l), !0)) || [], D = m(B, 2), I = D[0], q = D[1], _ = new Response(vt(_.body, 65536, I, (function() {
                                q && q(), C && R()
                            }), bt), F)), p = p || "text", e.next = 25, Ot[ve.findKey(Ot, p) || "text"](_, t);
                        case 25:
                            return M = e.sent, !C && R(), O && O(), e.next = 30, new Promise((function(e, r) {
                                Ye(e, r, {
                                    data: M,
    ...
    var kt = function(e) {
        ...
        At = function(e) {
            for (var t, r, n = (e = ve.isArray(e) ? e : [e]).length, o = {}, i = 0; i < n; i++) {
                var a = void 0;
                if (r = t = e[i], !jt(t) && void 0 === (r = Tt[(a = String(t)).toLowerCase()])) throw new ye("Unknown adapter '".concat(a, "'"));
                if (r) break;
                o[a || "#" + i] = r
            }
            if (!r) {
    ...
    function Lt(e) {
        return Pt(e), e.headers = Ke.from(e.headers), e.data = Ve.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), At(e.adapter || qe.adapter)(e).then((function(t) {
    ...
    _t.transitional = function(e, t, r) {
        function n(e, t) {
            return "[Axios v1.7.3] Transitional option '" + e + "'" + t + (r ? ". " + r : "")
        }
    ...
    var Ft = {
        ...
        Bt = function() {
            ...
            return v(e, [{
                ...
                key: "getUri",
                value: function(e) {
                    return je(it((e = st(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer)
                }
            }]), e
        }();
